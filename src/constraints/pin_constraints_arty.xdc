...
#BTN 1 = START
set_property -dict { PACKAGE_PIN D20    IOSTANDARD LVCMOS33 } [get_ports { start_btn }]; #IO_L4N_T0_35 Sch=BTN1
...
set_property -dict { PACKAGE_PIN Y11   IOSTANDARD LVCMOS33 } [get_ports { tx_out }]; #IO_L18N_T2_13      Sch=CK_A0
